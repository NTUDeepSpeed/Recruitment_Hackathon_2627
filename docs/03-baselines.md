...
Two things worth knowing before you commit to one. Rule 38 applies to a neural
...
policy that crashes out on lap three. Get something finishing first, then get
clever.
